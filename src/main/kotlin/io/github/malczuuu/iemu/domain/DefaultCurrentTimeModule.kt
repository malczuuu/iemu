...
class DefaultCurrentTimeModule(private val timer: Timer) : CurrentTimeModule {

  private val onCurrentTimeChange: MutableList<(Instant) -> Unit> = mutableListOf()

  private var diff: Long = 0

  override var timeZone: String = TimeZone.getDefault().id

  override var utcOffset: String = SimpleDateFormat("X").format(Calendar.getInstance().time)

  override var currentTime: Instant
